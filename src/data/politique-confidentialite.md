# Politique de confidentialité de Bweb Agence

**Version :** 1.0  
**Dernière mise à jour :** 27 juillet 2026  
**Entrée en vigueur :** 27 juillet 2026

> **À compléter avant publication.** Les éléments entre crochets (`[ … ]`) doivent être remplacés par les informations exactes de Bweb Agence. Les listes de services, cookies et sous-traitants doivent être limitées à ceux effectivement utilisés. Ce document décrit des engagements de transparence ; il doit être relu et validé par un conseil juridique qualifié au regard de l’organisation, des contrats, des flux de données et de la réglementation effectivement applicables.

## Table des matières

1. [Préambule](#1-préambule)
2. [Qui sommes-nous ?](#2-qui-sommes-nous-)
3. [Champ d’application](#3-champ-dapplication)
4. [Cadre juridique et principes](#4-cadre-juridique-et-principes)
5. [Définitions](#5-définitions)
6. [Données que nous collectons](#6-données-que-nous-collectons)
7. [Finalités de nos traitements](#7-finalités-de-nos-traitements)
8. [Fondements et conditions de licéité](#8-fondements-et-conditions-de-licéité)
9. [Cookies et technologies similaires](#9-cookies-et-technologies-similaires)
10. [Google Maps, contenus intégrés et services tiers](#10-google-maps-contenus-intégrés-et-services-tiers)
11. [Intelligence artificielle, automatisation et chatbots](#11-intelligence-artificielle-automatisation-et-chatbots)
12. [Newsletter, prospection et CRM](#12-newsletter-prospection-et-crm)
13. [Hébergement, sécurité et continuité](#13-hébergement-sécurité-et-continuité)
14. [Transferts internationaux](#14-transferts-internationaux)
15. [Durées de conservation](#15-durées-de-conservation)
16. [Vos droits et leur exercice](#16-vos-droits-et-leur-exercice)
17. [Mineurs](#17-mineurs)
18. [Violations de données](#18-violations-de-données)
19. [Sous-traitants, partenaires et responsabilités](#19-sous-traitants-partenaires-et-responsabilités)
20. [Évolution de la politique](#20-évolution-de-la-politique)
21. [Contact et réclamation](#21-contact-et-réclamation)
22. [Annexes opérationnelles](#22-annexes-opérationnelles)
...
Les textes officiels sont consultables sur le site de l’ARTCI : [lois et ordonnances](https://www.artci.ci/index.php?Itemid=118&id=35&option=com_content&view=category). L’ARTCI rappelle que les structures traitant des données personnelles doivent évaluer leur conformité à la loi n° 2013-450 et que l’Autorité veille à ce que l’usage des TIC ne porte pas atteinte à la vie privée. Les exigences précises peuvent évoluer ; nous réévaluons nos pratiques en conséquence.
...
Pour exercer un droit, écrivez à **[privacy@domaine.tld]** ou par courrier à l’adresse indiquée à la section 2, avec l’objet « Données personnelles — exercice de droits ». Indiquez votre nom, le moyen par lequel nous pouvons vous répondre, le traitement concerné si vous le connaissez et la nature de votre demande. Vous n’avez pas à employer un formulaire particulier.
...
1. **Détection et signalement** : réception d’une alerte issue d’un utilisateur, d’un journal, d’un fournisseur ou d’un contrôle interne.
2. **Qualification** : vérification de l’incident, identification des systèmes, données, personnes et périodes potentiellement concernés.
3. **Confinement** : révocation d’accès, isolation d’un service, changement de secret, blocage d’un flux ou autre mesure immédiate adaptée.
4. **Investigation et preuve** : analyse des causes, préservation des journaux, évaluation de l’accès réel, de l’exfiltration et des risques.
5. **Remédiation** : correction de la vulnérabilité, restauration contrôlée, renforcement de la surveillance et actions préventives.
6. **Notification** : information de l’ARTCI, des autres autorités compétentes, du client responsable ou des personnes concernées lorsque la loi et l’évaluation des risques l’exigent.
7. **Retour d’expérience** : documentation, amélioration de la procédure, formation ou évolution technique.
...
Les versions antérieures significatives peuvent être conservées dans une archive accessible sur demande à **[privacy@domaine.tld]**, lorsque cette conservation est utile pour retracer les engagements applicables à une période donnée. La version affichée en ligne prévaut pour les traitements réalisés à compter de sa date d’entrée en vigueur, sous réserve des règles impératives applicables.
...
- Ressources, lois et communications de l’[ARTCI](https://www.artci.ci/), Autorité de protection des données en Côte d’Ivoire.
